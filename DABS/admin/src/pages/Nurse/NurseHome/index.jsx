...
import { Card, Row, Col, List, Avatar, Typography, Tag, Button } from "antd";
import { UserOutlined, NotificationOutlined, ClockCircleOutlined, CheckCircleOutlined } from "@ant-design/icons";
const NurseHome = () => {
...
const fakeNotifications = [
  { id: 1, content: "Đào tạo quy trình chăm sóc mới ngày 30/06/2025", date: "28/06/2025" },
  { id: 2, content: "Lịch họp khoa ngày 01/07/2025", date: "29/06/2025" },
];
...
const statusColor = {
  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: 24 }}>
      <Title level={2}>Chào điều dưỡng Nguyễn Thị H</Title>
      ...
      <Row gutter={16}>
        <Col span={16}>
          <Card title="Ca trực hôm nay">
            ...
            <Text strong>Số bệnh nhân cần chăm sóc: </Text> {fakeShift.patientCount} <br />
            <Tag color={fakeShift.status === "Đang làm" ? "green" : "blue"} style={{ marginTop: 8 }}>
              {fakeShift.status}
            </Tag>
          </Card>

          <Card title="Bệnh nhân cần chăm sóc" style={{ marginTop: 24 }}>
            <List
              ...
              renderItem={(patient) => (
                ...
                >
                  <List.Item.Meta
                    ...
                    title={`${patient.name} (Tuổi: ${patient.age})`}
          ...
          <Card title="Nhiệm vụ cần làm" style={{ marginTop: 24 }}>
            <List
