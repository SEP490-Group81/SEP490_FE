...
// Fake staff data
const staffs = [
    { id: 100, name: "Nguyễn Thị Nhân Viên A" },
    { id: 101, name: "Trần Văn Nhân Viên B" },
    { id: 102, name: "Phạm Nhân Viên C" }
];
...
const StaffShiftManagement = () => {
    ...
    const [selectedstaffId, setSelectedstaffId] = useState(100);
        ...
        const data = [
            {
                id: 1,
                staffId: 100,
                staffName: "Nguyễn Thị Nhân Viên A",
                workDate: "2025-07-04",
                startTime: "08:00:00",
                endTime: "12:00:00",
                roomName: "Phòng 202",
            ...
            },
            {
                id: 2,
                staffId: 101,
                staffName: "Trần Văn Nhân Viên B",
                workDate: "2025-07-04",
                startTime: "13:00:00",
                endTime: "17:00:00",
                roomName: "Phòng 203",
    ...
    const onFinish = (values) => {
        const newShift = {
            ...
            staffName: staffs.find(n => n.id === values.staffId)?.name || "",
    ...
    const onFinishBulk = (values) => {
        ...
        while (current.isSameOrBefore(endDate, 'day')) {
            if (weekdays.includes(current.day())) {
                staffIds.forEach(id => {
                    const staff = staffs.find(n => n.id === id);
                    shiftsToAdd.push({
            ...
            <div style={{ margin: "0 auto", padding: 10, backgroundColor: "#fff", borderRadius: 8 }}>
                ...
                <Row gutter={24}>
                    <Col xl={8} lg={24} md={24} sm={24} xs={24} style={{ marginBottom: 16 }}>
                        <h2>Tạo lịch mẫu cho Nhân Viên</h2>
                        <Form layout="vertical" form={bulkForm} onFinish={onFinishBulk}>
                            <Form.Item name="staffIds" label="Nhân Viên" rules={[{ required: true }]}>
                                <Select
                                    mode="multiple"
